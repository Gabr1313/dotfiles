return {
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<BS>h", mark.add_file,{ desc = "[H]arpoon insert" })
            vim.keymap.set("n", "<BS>m", ui.toggle_quick_menu, { desc = "[H]arpoon menu" })
            ...
            vim.keymap.set("n", "<BS>;", function() ui.nav_file(4) end, { desc = "Harpoon 4" })
        end
    },
}
