...
static const int repeat_rate = 64;
static const int repeat_delay = (int)1e31;
...
static const char *toggleLaptopMonitor[] = { "wlr-randr", "--output", "eDP-1", "--toggle", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_m,          spawn,            {.v = toggleLaptopMonitor} },
